...
그래서 찾아보니까 k9s views.yaml에서 라벨을 커스텀 컬럼으로 뽑을 수 있었습니다. Karpenter NodePool에 붙여둔 라벨을 TYPE 컬럼으로 맨 앞에 빼니까 app, worker, gpu 같은 용도가 바로 보여서 훨씬 편해졌어요.
...
Turns out k9s views.yaml lets you extract labels into custom columns. By pulling the Karpenter NodePool label into a TYPE column up front, I can instantly see app, worker, gpu — much easier to work with.
